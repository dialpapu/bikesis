...
class InventariosControllerTest < ActionController::TestCase
  ...
  test "should create inventario" do
    assert_difference('Inventario.count') do
      post :create, inventario: { cantidadProductos: @inventario.cantidadProductos, idProducto: @inventario.idProducto }
    end
  ...
  test "should update inventario" do
    patch :update, id: @inventario, inventario: { cantidadProductos: @inventario.cantidadProductos, idProducto: @inventario.idProducto }
    assert_redirected_to inventario_path(assigns(:inventario))
  end
