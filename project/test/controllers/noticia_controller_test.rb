...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { cuerpo: @noticium.cuerpo, estadoNoticia: @noticium.estadoNoticia, fechaPublicacion: @noticium.fechaPublicacion, idGerente: @noticium.idGerente, idNoticia: @noticium.idNoticia, resumen: @noticium.resumen }
    end
  ...
  test "should update noticium" do
    patch :update, id: @noticium, noticium: { cuerpo: @noticium.cuerpo, estadoNoticia: @noticium.estadoNoticia, fechaPublicacion: @noticium.fechaPublicacion, idGerente: @noticium.idGerente, idNoticia: @noticium.idNoticia, resumen: @noticium.resumen }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
